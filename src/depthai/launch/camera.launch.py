...
def launch_setup(context, *args, **kwargs):
    ...
    urdf_launch_dir = os.path.join(get_package_share_directory('depthai'), 'launch')
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("params_file", default_value=os.path.join(depthai_prefix, 'config', 'camera_copy.yaml')),
